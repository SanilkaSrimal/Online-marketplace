        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="view_orders.php"><b>View orders</b></a></li>
                    <li class="nav-item"><a class="nav-link" href="upload_product.php"><b>Add Products</b></a></li>
                    <li class="nav-item"><a class="nav-link" href="create_main_category.php"><b>Add Categories</b></a></li>
                    <li class="nav-item"><a class="nav-link" href="create_subcategory.php"><b>Add Subcategories</b></a></li>
                ...
                <div class="row">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<p class="text-success"><strong>Price:</strong> Rs.' . htmlspecialchars($row['price']) . '</p>';
                            echo '<a href="add_to_cart.php?id=' . $row['id'] . '" class="btn btn-primary mt-auto">Add to cart</a>';
                            echo '</div>';
                            echo '</div>';
                            echo '</div>';
                        }
